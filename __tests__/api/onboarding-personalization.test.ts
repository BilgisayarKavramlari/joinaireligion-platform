...
const FULL_ANSWERS = {
  ...
  draw:                    "I am looking for a grounded reflective path.",
  conflict:                "Seek solitude and reflect",
  higher_power:            "A quiet underlying presence.",
  practice:                "Daily meditation or contemplation",
  obstacle:                "Restlessness and scattered attention.",
  awakening:               "Becoming more awake to reality as it is.",
