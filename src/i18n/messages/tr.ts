export default {
  ...
  home: {
    ...
    disclaimer: "Dini otorite, tıbbi bakım, psikolojik tedavi veya kriz hizmeti değildir.",
    ctas: { create: "Hesap oluştur", pricing: "Fiyatları gör", donate: "Bağış yap", promptGuide: "Prompt rehberini oku" },
  },
} as const;
