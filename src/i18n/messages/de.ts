export default {
  ...
  home: {
    ...
    disclaimer: "Keine religiöse Autorität, medizinische Versorgung, psychologische Behandlung oder Krisenhilfe.",
    ctas: { create: "Konto erstellen", pricing: "Preise ansehen", donate: "Spenden", promptGuide: "Leitfaden lesen" },
  },
} as const;
