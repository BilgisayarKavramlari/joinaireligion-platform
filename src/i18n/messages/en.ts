export default {
  ...
  home: {
    ...
    disclaimer: "Not a religious authority, medical care, psychological treatment, or crisis service.",
    ctas: { create: "Create account", pricing: "View pricing", donate: "Donate", promptGuide: "Read prompt guide" },
  },
} as const;
