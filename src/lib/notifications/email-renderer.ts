...
type NotificationLocale = "en" | "tr" | "es" | "de" | "fr" | "ar" | "ru" | "zh";
...
const COPY: Record<NotificationLocale, {
  ...
  ar: { greeting: "مرحباً", lessonReady: "درسك الجديد جاهز", lessonBody: "أضيف درس شخصي جديد إلى رحلتك.", openLesson: "افتح الدرس", articleReady: "يتوفر تأمل جديد", articleBody: "نُشر مقال جديد باللغة التي اخترتها.", readArticle: "اقرأ المقال", preferences: "إدارة تفضيلات البريد", unsubscribe: "إلغاء الاشتراك", disclaimer: "محاكاة تأملية تعليمية تخيلية · ليست سلطة دينية ولا نصيحة مهنية" },
